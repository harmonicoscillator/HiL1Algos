# This configuration runs on RECO prepared with 'try1pmuon.py' (located in the same folder)
# Includes L1 GCT information, tracks, and jets.
...
ivars.inputFiles = "file:/mnt/hadoop/cms/store/user/icali/HIHighPt/HIHIHighPt_Skim_HLT_HIFullTrack14_RECO/0e004a3212cb57168d8309f8827de16c/step2_RAW2DIGI_L1Reco_RECO_16_1_xvk.root"
...
##################### Track Analyzers
process.anaTrack.trackSrc = cms.InputTag("hiSelectedTracks") # only single iteraction track for Wei's single track v2 studies
