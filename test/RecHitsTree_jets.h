...
#ifndef RecHitsTree_jets_h
#define RecHitsTree_jets_h
...
#ifdef RecHitsTree_jets_cxx
RecHitsTree_jets::RecHitsTree_jets(TFile *f)
{
...
RecHitsTree_jets::~RecHitsTree_jets()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t RecHitsTree_jets::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t RecHitsTree_jets::LoadTree(Long64_t entry)
{
...
void RecHitsTree_jets::Init(TTree *tree)
{
...
Bool_t RecHitsTree_jets::Notify()
{
...
void RecHitsTree_jets::Show(Long64_t entry)
{
...
Int_t RecHitsTree_jets::Cut(Long64_t entry)
{
...
#endif // #ifdef RecHitsTree_jets_cxx
