...
#ifndef TriggerPrimitivesTree_h
#define TriggerPrimitivesTree_h
...
class TriggerPrimitivesTree {
  ...
  TriggerPrimitivesTree(TTree *tree=0);
  virtual ~TriggerPrimitivesTree();
...
#ifdef TriggerPrimitivesTree_cxx
TriggerPrimitivesTree::TriggerPrimitivesTree(TTree *tree)
{
...
TriggerPrimitivesTree::~TriggerPrimitivesTree()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t TriggerPrimitivesTree::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t TriggerPrimitivesTree::LoadTree(Long64_t entry)
{
...
void TriggerPrimitivesTree::Init(TTree *tree)
{
...
Bool_t TriggerPrimitivesTree::Notify()
{
...
void TriggerPrimitivesTree::Show(Long64_t entry)
{
...
Int_t TriggerPrimitivesTree::Cut(Long64_t entry)
{
...
#endif // #ifdef TriggerPrimitivesTree_cxx
