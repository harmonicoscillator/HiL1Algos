...
#ifndef TriggerPrimitivesTree_jetcurve_h
#define TriggerPrimitivesTree_jetcurve_h
...
class TriggerPrimitivesTree_jetcurve {
public :
...
#ifdef TriggerPrimitivesTree_jetcurve_cxx
TriggerPrimitivesTree_jetcurve::TriggerPrimitivesTree_jetcurve(TFile *f)
{
...
TriggerPrimitivesTree_jetcurve::~TriggerPrimitivesTree_jetcurve()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t TriggerPrimitivesTree_jetcurve::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t TriggerPrimitivesTree_jetcurve::LoadTree(Long64_t entry)
{
...
void TriggerPrimitivesTree_jetcurve::Init(TTree *tree)
{
...
Bool_t TriggerPrimitivesTree_jetcurve::Notify()
{
...
void TriggerPrimitivesTree_jetcurve::Show(Long64_t entry)
{
...
Int_t TriggerPrimitivesTree_jetcurve::Cut(Long64_t entry)
{
...
#endif // #ifdef TriggerPrimitivesTree_jetcurve_cxx
