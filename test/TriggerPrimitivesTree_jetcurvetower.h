...
#ifndef TriggerPrimitivesTree_jetcurvetower_h
#define TriggerPrimitivesTree_jetcurvetower_h
...
class TriggerPrimitivesTree_jetcurvetower {
public :
  ...
  TriggerPrimitivesTree_jetcurvetower(TFile *f=0);
  virtual ~TriggerPrimitivesTree_jetcurvetower();
  virtual Int_t    Cut(Long64_t entry);
  virtual Int_t    GetEntry(Long64_t entry);
  virtual Long64_t LoadTree(Long64_t entry);
  virtual void     Init(TTree *tree);
  virtual TGraphAsymmErrors*    Loop(int total_events = -1,
			int threshhold = 0,
...
#ifdef TriggerPrimitivesTree_jetcurvetower_cxx
TriggerPrimitivesTree_jetcurvetower::TriggerPrimitivesTree_jetcurvetower(TFile *f)
{
...
TriggerPrimitivesTree_jetcurvetower::~TriggerPrimitivesTree_jetcurvetower()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t TriggerPrimitivesTree_jetcurvetower::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t TriggerPrimitivesTree_jetcurvetower::LoadTree(Long64_t entry)
{
...
void TriggerPrimitivesTree_jetcurvetower::Init(TTree *tree)
{
...
Bool_t TriggerPrimitivesTree_jetcurvetower::Notify()
{
...
void TriggerPrimitivesTree_jetcurvetower::Show(Long64_t entry)
{
...
Int_t TriggerPrimitivesTree_jetcurvetower::Cut(Long64_t entry)
{
...
#endif // #ifdef TriggerPrimitivesTree_jetcurvetower_cxx
