...
#ifndef TriggerPrimitivesTree_jetrate_h
#define TriggerPrimitivesTree_jetrate_h
...
class TriggerPrimitivesTree_jetrate {
public :
  ...
  TriggerPrimitivesTree_jetrate(TFile *f=0);
  virtual ~TriggerPrimitivesTree_jetrate();
...
#ifdef TriggerPrimitivesTree_jetrate_cxx
TriggerPrimitivesTree_jetrate::TriggerPrimitivesTree_jetrate(TFile *f)
{
...
TriggerPrimitivesTree_jetrate::~TriggerPrimitivesTree_jetrate()
{
  if (!fChain) return;
  //delete fChain->GetCurrentFile();
}

Int_t TriggerPrimitivesTree_jetrate::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t TriggerPrimitivesTree_jetrate::LoadTree(Long64_t entry)
{
...
void TriggerPrimitivesTree_jetrate::Init(TTree *tree)
{
...
Bool_t TriggerPrimitivesTree_jetrate::Notify()
{
...
void TriggerPrimitivesTree_jetrate::Show(Long64_t entry)
{
...
Int_t TriggerPrimitivesTree_jetrate::Cut(Long64_t entry)
{
...
#endif // #ifdef TriggerPrimitivesTree_jetrate_cxx
