...
#ifndef TriggerPrimitivesTree_single_h
#define TriggerPrimitivesTree_single_h
...
class TriggerPrimitivesTree_single {
public :
  ...
  TriggerPrimitivesTree_single(TFile *f=0);
  virtual ~TriggerPrimitivesTree_single();
  virtual Int_t    Cut(Long64_t entry);
  virtual Int_t    GetEntry(Long64_t entry);
  virtual Long64_t LoadTree(Long64_t entry);
  virtual void     Init(TTree *tree);
  virtual void     Loop(int single_event = 0, 
			int threshhold = 0,
			enum CALIBRATION_TYPE calibration = NO,
...
#ifdef TriggerPrimitivesTree_single_cxx
TriggerPrimitivesTree_single::TriggerPrimitivesTree_single(TFile *f)
{
...
TriggerPrimitivesTree_single::~TriggerPrimitivesTree_single()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t TriggerPrimitivesTree_single::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t TriggerPrimitivesTree_single::LoadTree(Long64_t entry)
{
...
void TriggerPrimitivesTree_single::Init(TTree *tree)
{
...
Bool_t TriggerPrimitivesTree_single::Notify()
{
...
void TriggerPrimitivesTree_single::Show(Long64_t entry)
{
...
Int_t TriggerPrimitivesTree_single::Cut(Long64_t entry)
{
...
#endif // #ifdef TriggerPrimitivesTree_single_cxx
