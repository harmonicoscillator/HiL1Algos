...
#ifndef TriggerPrimitivesTree_towerjet_h
#define TriggerPrimitivesTree_towerjet_h
...
class TriggerPrimitivesTree_towerjet {
public :
  ...
  TriggerPrimitivesTree_towerjet(TFile *f=0);
  virtual ~TriggerPrimitivesTree_towerjet();
...
#ifdef TriggerPrimitivesTree_towerjet_cxx
TriggerPrimitivesTree_towerjet::TriggerPrimitivesTree_towerjet(TFile *f)
{
  ...
  fhiinfo = new HiTree::HiTree((TTree*)f->Get("hiEvtAnalyzer/HiTree"));
...
Long64_t TriggerPrimitivesTree_towerjet::LoadTree(Long64_t entry)
{
...
void TriggerPrimitivesTree_towerjet::Init(TTree *tree)
{
...
Bool_t TriggerPrimitivesTree_towerjet::Notify()
{
...
void TriggerPrimitivesTree_towerjet::Show(Long64_t entry)
{
...
Int_t TriggerPrimitivesTree_towerjet::Cut(Long64_t entry)
{
...
#endif // #ifdef TriggerPrimitivesTree_towerjet_cxx
